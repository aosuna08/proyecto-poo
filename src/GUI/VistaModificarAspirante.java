 ...
 * @author feco2
 */
public class VistaModificarAspirante extends javax.swing.JFrame {

    /**
     * Creates new form Agregar
     */
    public VistaModificarAspirante() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaModificarAspirante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaModificarAspirante().setVisible(true);
            }
        });
    }
